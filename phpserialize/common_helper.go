...
//PhpValueString PhpValue转换string
func PhpValueString(p PhpValue) (res string) {
	res, _ = p.(string)
	return
}

//PhpValueBool PhpValue转换bool
...
//PhpValueUInt64 PhpValue转换uint64
...
//PhpValueFloat64 PhpValue转换float64
